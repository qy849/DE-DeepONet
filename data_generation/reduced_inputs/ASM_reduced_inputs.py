...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Generate ASM reduced inputs .')
    ...
    ASM_reduced_inputs = input_nodal_values @ temp_matrix
    save_npy(dataset_path+'/reduced_inputs/ASM.npy', ASM_reduced_inputs)
