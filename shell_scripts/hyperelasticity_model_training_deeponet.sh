...
config_models_path="$repo_path/configs/hyperelasticity/config_models/deeponet"
before_training_models_path="$repo_path/results/hyperelasticity/saved_models/before_training/deeponet"
after_training_models_path="$repo_path/results/hyperelasticity/saved_models/after_training/deeponet"

train_args_path="$repo_path/configs/hyperelasticity/config_training/deeponet/train_args.yaml"
update_train_args_path="$repo_path/configs/hyperelasticity/config_training/deeponet/update_train_args.yaml"
train_dataset_path="$repo_path/results/hyperelasticity/train_dataset"

test_args_path="$repo_path/configs/hyperelasticity/config_training/deeponet/test_args.yaml"
test_dataset_path="$repo_path/results/hyperelasticity/test_dataset"
test_dm_path="$repo_path/results/hyperelasticity/test_dm"

loss_and_error_path="$repo_path/results/hyperelasticity/loss_and_error/deeponet"
