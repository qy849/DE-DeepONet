...
for input_reduced_basis_name in "${input_reduced_basis_names[@]}"; do
    for output_reduced_basis_name in "${output_reduced_basis_names[@]}"; do
        ...
        config_models_path="$repo_path/configs/hyperelasticity/config_models/dino/${input_reduced_basis_name}_${output_reduced_basis_name}"
        before_training_models_path="$repo_path/results/hyperelasticity/saved_models/before_training/dino/${input_reduced_basis_name}_${output_reduced_basis_name}"
        after_training_models_path="$repo_path/results/hyperelasticity/saved_models/after_training/dino/${input_reduced_basis_name}_${output_reduced_basis_name}"

        train_args_path="$repo_path/configs/hyperelasticity/config_training/dino/${input_reduced_basis_name}_${output_reduced_basis_name}/train_args.yaml"
        update_train_args_path="$repo_path/configs/hyperelasticity/config_training/dino/${input_reduced_basis_name}_${output_reduced_basis_name}/update_train_args.yaml"
        train_dataset_path="$repo_path/results/hyperelasticity/train_dataset"
        
        test_args_path="$repo_path/configs/hyperelasticity/config_training/dino/${input_reduced_basis_name}_${output_reduced_basis_name}/test_args.yaml"
        test_dataset_path="$repo_path/results/hyperelasticity/test_dataset"
        test_dm_path="$repo_path/results/hyperelasticity/test_dm"

        loss_and_error_path="$repo_path/results/hyperelasticity/loss_and_error/dino/${input_reduced_basis_name}_${output_reduced_basis_name}"
